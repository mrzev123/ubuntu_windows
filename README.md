...
`wget -P /media/script https://raw.githubusercontent.com/mrzev123/ubuntu_windows/main/mediabots_Ubuntu-to-Windows2019.sh`

`chmod +x /media/script/*`

`/media/script/mediabots_Ubuntu-to-Windows2019.sh`
